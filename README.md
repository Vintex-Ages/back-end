...
`test-localstack` e `test-ministack` executam smoke tests reais nos emuladores (VE-20/VE-21). `test-interoperability` ainda é placeholder da VE-22. O módulo Terraform de VPC Link pertence à VE-19 (#170), em hold.
